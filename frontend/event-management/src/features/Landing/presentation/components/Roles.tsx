  ...
  const rolesData = [
    {
      ...
      desc: 'Gerez tous les utilisateurs, consultez leurs activités, supprimez des comptes et supervisez l’ensemble de la plateforme.',
    ...
    },
    {
      ...
      features: ['Création d’événements illimitée', 'Statuts draft/publié/annulé', 'Suivi des inscriptions', 'Dashboard avec 4 métriques'],
    }
  ];
    ...
    <section className="py-20 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-6">
        {rolesData.map((role, idx) => (
          <div key={idx} className={`p-8 rounded-2xl bg-white dark:bg-[#12131a] border border-gray-100 dark:border-gray-900/60 ${role.borderColor} shadow-sm`}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {role.features.map((feat, fIdx) => (
                <div key={fIdx} className="flex items-center gap-2.5 text-sm text-gray-600 dark:text-gray-300">
                  <div className="p-1 rounded-full bg-emerald-500/10 dark:bg-emerald-500/20 text-emerald-500">
