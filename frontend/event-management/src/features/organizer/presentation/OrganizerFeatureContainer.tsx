    ...
    <div className="bg-slate-50 min-h-screen font-sans antialiased">
      <header className="bg-white border-b border-slate-100 px-6 py-3 flex justify-between items-center sticky top-0 z-50">
        <div 
          ...
          className="flex items-center gap-2 cursor-pointer text-indigo-600 font-black text-base tracking-tight"
        >
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className={`flex items-center gap-1.5 text-xs font-bold px-3 py-1.5 rounded-xl transition ${
              view === 'profile' ? 'bg-indigo-600 text-white shadow-sm' : 'bg-indigo-50 text-indigo-600 hover:bg-indigo-100'
            }`}
          >
