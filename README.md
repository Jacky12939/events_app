...
Application de gestion d'événements · React + TypeScript + Tailwind CSS
...
## Activer le dark mode dans Tailwind
...
Dans `tailwind.config.js` (si présent) ou `vite.config.ts`, ajoutez le support du dark mode basé sur la classe :
...
| Outil | Usage |
|---|---|
| React 19 + TypeScript | UI & logique |
| Tailwind CSS v4 | Styles utilitaires |
| React Router DOM v7 | Navigation |
| React Hook Form | Gestion des formulaires |
| Zod | Validation des schémas |
| React Icons (Fi) | Icônes Feather |
| Framer Motion | Animations *(disponible, non encore utilisé)* |
